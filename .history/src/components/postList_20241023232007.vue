    ...
    return {
      posts: [
        ...
        },
        {
          ...
          image1: require('@/assets/images/HNU.jpg'),
          comments: [
            { name: 'Bob', content: 'You see see you !' },
            { name: 'Jack', content: 'One day day 的!' },
            { name: 'Rose', content: 'What things have you ever done ?!' }
...
.card-item {
  ...
  /*set card width to 33.33% and add 16px gutters */
  margin-bottom: 16px;
  /*add 16px margin between cards */
}

@media (max-width: 1024px) {
  .card-item {
    flex: 0 1 calc(50% - 16px);
    /*display only 2 cards per row on smaller screens */
  }
}
...
@media (max-width: 600px) {
  .card-item {
    flex: 0 1 100%;
    /* display only one card per row on smaller screens */
  }
}
</style>
