        ...
        <div v-if="selectedPost" style="display: flex;flex-direction: row;">
          ...
          <div class="carousel-container" style="width: 1500px;height: 100%;">
            ...
            <div id="carouselExample" class="carousel slide" data-bs-ride="carousel"
              style="margin-top: calc(50% - 200px);">

              <div class="carousel-indicators" v-if="selectedPost.image2">
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <img :src="selectedPost.image1" class="d-block w-100" alt="Image 1"
                    style="object-fit: contain;width:100%;">
                </div>

                <div class="carousel-item" v-if="selectedPost.image2">
                  <img :src="selectedPost.image2" class="d-block w-100" alt="Image 2"
                    style="object-fit: contain;width:100%;">
                </div>
              </div>
              ...
              <button class="carousel-control-prev" type="button" data-bs-target="#carouselExample"
                v-if="selectedPost.image2" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
              </button>
              <button class="carousel-control-next" type="button" data-bs-target="#carouselExample"
                v-if="selectedPost.image2" data-bs-slide="next">
          ...
          <div class="content-container" style="width: 1100px;border-left: 1px solid gainsboro;">
            ...
            <div class="scroll_item">
              ...
              <h5
                style="margin-left: 2%;margin-top: 20px;border-top: 1px solid gainsboro;padding-top: 10px;font-weight: bold;">
                {{ selectedPost.comments.length }} comments in total</h5>
              <CommentsCardsVue :comments="selectedPost.comments" @delete-comment="handleDeleteComment">
              </CommentsCardsVue>

            </div>

            <div class="comment_cards_input"
              style="position: absolute;bottom:50px;width: 450px;display: flex;flex-direction:row;height: 50px;;">
              <input class="form-control" aria-label="With textarea" placeholder="     Please input your comment"
                v-model="content" style="width: 100%;height: 40px;padding: 0;border-radius: 30px;">
              <button class="btn btn-outline-secondary btn-primary" type="button" @click="submitClick()"
                style="height: 40px;border-radius: 20px;margin-left: 5px;color: white;">send</button>
            </div>

          </div>

        </div>
        <!-- <CommentsCardsVue :comments="selectedPost.comments" @delete-comment="handleDeleteComment"></CommentsCardsVue> -->
      </ModalPartVue>
    </div>
...
import CommentsCardsVue from '@/components/CommentsCards.vue';
