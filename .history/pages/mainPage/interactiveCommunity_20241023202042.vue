        ...
        <div v-if="selectedPost" style="display: flex;flex-direction: row;">
          ...
          <div class="content-container" style="width: 1100px;border-left: 1px solid gainsboro;">
            ...
            <div class="scroll_item">
              ...
              <comments_cardsVue :comments="selectedPost.comments" @delete-comment="handleDeleteComment">
              </comments_cardsVue>
...
<script>
import danmuCardVue from '../../src/components/DanmuCard.vue';
import postListVue from '../../src/components/postList.vue';
import modalPartVue from '../../src/components/modalPart.vue';
import comments_cardsVue from '../../src/components/CommentsCards.vue';
