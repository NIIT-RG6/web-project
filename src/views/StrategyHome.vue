      ...
      <div class="top-content">
        <div class="item">
          ...
          <div class="pop">
            ...
            <p>
              It's a stunning view from every angle, especially at sunset, making it a great place to take photos. Yundong Library is not only a place to check in for literature and art, but also a quiet corner where the soul can dwell.
            </p>
          </div>
        </div>
        <div class="item">
          ...
          <div class="pop">
            ...
            <p>
              Not only is there a lot of history, but also the prosperity of modern commerce, with a variety of snack bars, handicraft shops and specialty cafes dotted throughout, which is an excellent place to experience the authentic life of Haikou.
            </p>
          </div>
        </div>
        <div class="item">
          ...
          <div class="pop">
            ...
            <p>
              Holiday Beach is one of Haikou's beautiful coastlines, with fine sand and clear blue waters, it is the perfect place to relax and unwind. You can enjoy the sun, sand and sea breeze here, and feel the grandeur and gentleness of the sea.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="select-box">
      <div class="select-item">
        ...
        <span v-for="item in monthData" :key="item" :class="{active:monthIndex === item}"
              @click="monthIndex = item">{{ item }}</span>
      </div>
      <div class="select-item">
        <label>Days:</label>
        <span v-for="item in dayData" :key="item" :class="{active:dayIndex === item}"
              @click="dayIndex = item">{{ item }}</span>
      </div>
      <div class="select-item">
        <label>Number:</label>
...
export default {
  ...
  data() {
    return {
      ...
      /*      priceIndex: 'All',
            priceData: ['All', '1-999', '1000-2999', '3000-4999', '5000-9999', '10000以上'],*/
      personIndex: 'All',
