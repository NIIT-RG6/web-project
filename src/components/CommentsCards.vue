<template>
    ...
    <view v-for="(item, index) in comments" :key="index">
        ...
        <div class="comment_cards" style="margin-top: 20px;">
            ...
            <div class="forFlex" style="display: flex;flex-direction: row;">
                <img src="@/assets/images/my_icon.png" alt="" style="left: 5%;width: 60px;height: 60px;">
                ...
                <div class="text_content" style="display: flex;flex-direction: column;height: auto;">
                    ...
                    <text class="comment_content"
                        style="padding:15px; margin-left:10px;bottom: 0;margin-top: 3px;background-color: #f8f9fa;border-radius: 20px">
                        {{ item.content }} </text>
            ...
            <div class="function_content" style="margin-top: 6px;">
                ...
                <img v-show="!isLiked[index]" src="@/assets/images/like.png" alt=""
                    style="height: 20px;width: 20px;margin-left: 80px;" @click="accpet(index)">
                <img v-show="isLiked[index]" src="@/assets/images/isLiked.png" alt=""
                    style="height: 20px;width: 20px;margin-left: 80px;" @click="accpet(index)">

                <img src="@/assets/images/delete_icon.png" style="height: 20px;width: 20px;margin-left: 18px;" alt=""
    ...
    <view :style="{ display: comments && comments.length > 0 ? 'none' : 'block' }"
        style="text-align: center;margin-top: 35px;margin-bottom: 35px;align-items: center;">There is no comment here
    </view>
